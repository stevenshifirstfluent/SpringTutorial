...
public class OwnerController {
    ...
    // 1. Path variable
    // http://localhost:8081/owners/123
    @GetMapping("/{ownerId}")
    @ResponseBody
    ...
    // http://localhost:8081/owners/101/pets/1
    ...
    // 3. Query parameter
    // http://localhost:8081/owners?name=steven
    @GetMapping
    @ResponseBody
    ...
    // In postman, set the request method as POST, set the request URL as http://localhost:8081/owners
    // In the request body, we set the Body as raw in json format and paste the follow json data to the request body
//    {
//        "id":123,
//        "name":"Steven"
//    }
